...
export default function CertificateCarousel({ certificates }: { certificates: CertificateCard[] }) {
  const [activeCert, setActiveCert] = useState<CertificateCard | null>(null);
  ...
  const scrollStep = useCallback(() => {
    if (!trackRef.current || isPaused || certificates.length === 0) return;
    ...
    <section className="w-full bg-surface-container-lowest py-16 overflow-hidden">
      ...
      {certificates.length === 0 ? (
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-xl border border-outline-variant/15 bg-surface-container-high p-6 text-on-surface-variant">
            No competition certificates available yet.
          </div>
        </div>
      ) : (
        <div
        ...
        >
          {[...certificates, ...certificates].map((cert, i) => (
            ...
            >
              ...
              <div className="p-5">
                <span className="font-label text-[0.6rem] uppercase tracking-widest font-bold text-primary">
                  {cert.issuer}
                </span>
          ...
          >
            ...
            <div className="p-6 flex flex-col gap-3">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-2">
                <a
                  href={`/competition#${activeCert.competitionSlug}`}
